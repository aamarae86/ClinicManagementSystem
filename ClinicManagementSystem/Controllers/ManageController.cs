    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                TempData["IsSuccessfullypasswordChanged"] = true;
                return RedirectToAction("UserProfile","User", new { ShowProfile = true, msg=string.Empty});//, new { Message = ManageMessageId.ChangePasswordSuccess });
            }
            AddErrors(result);
            return View(model);
        }
